...
constexpr float kRemoteInterpolationDelaySeconds = 0.1f; // reduce to improve feel
constexpr float kPredictionHardSnapThresholdPx = 28.0f;
constexpr float kPredictionReconcileGain = 10.0f;
