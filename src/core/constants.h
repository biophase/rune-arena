...
constexpr float kFireSpiritTargetRangeTiles = 16.0f;
constexpr float kFireSpiritTravelBaseSeconds = 0.5f;
constexpr float kFireSpiritTravelSecondsPerPixel = 0.0070f;
constexpr float kFireSpiritArcPeakHeight = 200.0f;
constexpr int kFireSpiritExplosionDamage = kProjectileDamage;
constexpr int kFireWaveSegmentCount = 12;
constexpr float kFireWaveRangeWorld = 128.0f;
constexpr float kFireWaveHalfAngleDegrees = 15.0f;
constexpr float kFireWaveDurationSeconds = 0.8f;
constexpr float kFireWaveFinalDiameterWorld =
    2.0f * kFireWaveRangeWorld * 0.26794919243f;  // 2 * tan(15deg) * range
constexpr float kEmbersSpawnRangeReductionTiles = 2.0f;
constexpr float kEmbersModifierDurationSeconds = 15.0f;
constexpr float kBurningStatusDurationSeconds = 3.0f;
constexpr float kBurningDamagePerSecond = 5.0f;
...
constexpr int kIceWallLengthCells = 4;
constexpr float kIceWallMaxHp = 100.0f;
constexpr float kIceWallHpDecayPerSecond = 2.5f;
...
constexpr float kGrapplingHookRangeTiles = 16.0f;
...
constexpr float kCastleInteractionRangeTiles = 5.0f;
constexpr float kCastleChargeDurationSeconds = 30.0f;
constexpr float kCastleChargeEnergyPerRune = 100.0f;
constexpr float kCastleChargeLightningIntervalSeconds = 0.18f;
...
constexpr const char* kSpriteSheet128x128TexturePath = "assets/sprite_sheet_128x128.png";
...
constexpr const char* kCastleLevelRequirementsPath = "assets/castle_level_requirements.json";
...
constexpr const char* kSfxVolatileCastPath = "assets/sfx/volatile_cast.wav";
...
constexpr const char* kSfxFireSpiritLaunchPath = "assets/sfx/EM_FIRE_CAST_01.ogg";
...
constexpr const char* kSfxCastleEquipRunePath = "assets/sfx/ogg/SFX/Chopping and Mining/mine 4.ogg";
constexpr const char* kSfxCastleUnequipRunePath = "assets/sfx/ogg/SFX/Chopping and Mining/mine 2.ogg";
...
constexpr const char* kEmbersLoopPath = "assets/sfx/EM_FIRE_HOLD_4s.ogg";
...
constexpr float kSfxVolumeFireSpiritLaunch = 0.75f;
...
constexpr float kSfxVolumeCastleEquipRune = 0.75f;
constexpr float kSfxVolumeCastleUnequipRune = 0.75f;
...
constexpr float kEmbersLoopVolume = 0.42f;
constexpr float kEmbersLoopFadeSeconds = 0.20f;
constexpr float kEmbersLoopCrossfadeSeconds = 1.0f;
